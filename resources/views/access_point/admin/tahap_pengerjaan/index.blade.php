        ...
        <div class="col-md-12">
            <div class="card card-outline-blue">
                <div class="card-header">
                    <h4 class="card-title">DAFTAR PEMESANAN YANG SEDANG DIKERJAKAN</h4>
                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {{--selesai--}}
                                        <form action="{{ route('move_to_done', $pemesanan->id) }}" method="POST">
                                            @csrf
                                            @method('PATCH')
                                        ...
                                        {{--apus--}}
                                        {{-- <form action="{{ route('daftar_pemesanan.destroy', $pemesanan->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('Are you sure you want to delete this item?');">
                                            @csrf
                                            @method('DELETE')
